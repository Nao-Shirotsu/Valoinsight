  ...
  },
  {
    ...
    subsections: [
      ...
      }
      {
        heading: '座学',
        items: [         
          { id: '??', text: '全ての武器のダメージと特徴を知っていますか', attributes: ['study'] },
          { id: '??', text: 'フルバイとハーフアーマーバイの金額を覚えていますか', attributes: ['study'] },
          { id: '??', text: '自分のアビリティの合計金額を知っていますか', attributes: ['study'] },
          { id: '??', text: 'スパイクを設置・解除した際に得られるメリットを全て知っていますか', attributes: ['study'] },
          { id: '??', text: 'スパイクの設置・爆発・解除にかかる秒数を知っていますか', attributes: ['study'] },
          { id: '??', text: '設置後のスパイクの見た目や音の変化で分かる情報を全て知っていますか', attributes: ['study'] },
          { id: '??', text: '今回のマップの、公式なエリアの名称を全て知っていますか', note: ['・ラフター, タピオカなど], attributes: ['study'] },
          { id: '??', text: '今回のマップの、非公式なエリアの俗称を概ね知っていますか', note: ['・ヘヴン, ザリガニなど], attributes: ['study'] },
          { id: '??', text: 'スナイパーがよく出てくる場所とエージェントを知っていますか', attributes: ['study'] },
          { id: '??', text: 'ショットガンがよく出てくる場所を知っていますか', attributes: ['study'] },
          { id: '??', text: '今回のマップで一般的に重要とされるエリアはどこか、理由も含めて説明できますか', attributes: ['study'] },
          { id: '??', text: '今回のマップで一般的に必須とされるエージェントを、理由も含めて説明できますか', attributes: ['study'] },
          { id: '??', text: '今回のマップの、一般的なプラント位置を全て知っていますか', attributes: ['study'] },
          { id: '??', text: '今回のマップにおける、一般的なチョークポイントを知っていますか', note: ['・チョークポイントとは：敵が出てくる所] , attributes: ['study'] },
          { id: '??', text: '今回のマップにおける、一般的なオフアングルを知っていますか', attributes: ['study'] },
          { id: '??', text: '今回のマップにおける、一般的な高所ポジションを知っていますか', note: ['・ジェットやオーメンなど、移動アビリティ使用後限定のポジションを含む] , attributes: ['study'] },
          { id: '??', text: '今回の試合で使われた全てのエージェントのシグネチャーアビリティと、そのリキャストタイムを知っていますか', attributes: ['study'] }, 
          { id: '??', text: '今回の試合で使われたエージェントの、全てのフラッシュ・スタンの効果と範囲を知っていますか', attributes: ['study'] }, 
          { id: '??', text: '今回のマップで、一般的にフラッシュやスタンが良く使われる場所を知っていますか', attributes: ['study'] },
          { id: '??', text: '今回の試合で使われた全てのセンチネルの持つ、トラップの一般的な定点と対策を知っていますか', attributes: ['study'] },
          { id: '??', text: '一般的なスモークの置き方と、その使い方を全て知っていますか', note: ['・閉じ・耐え・もっこり・1way など] attributes: ['study'] },
          { id: '??', text: '索敵アビリティが一般的にどこに投げられ、それがどのエリアを映す為のものか知っていますか', attributes: ['study'] },
          { id: '??', text: '今回のマップで、ドローン系の索敵が無ければ極めて進みづらいエリアがどこかを知っていますか', attributes: ['study'] },
          { id: '??', text: '今回の試合で互いのチームにモロトフが合計何個あり、それぞれ何秒あるか知っていますか', attributes: ['study'] },
          { id: '??', text: '敵のイニシエーターとキルジョイとクローヴのウルトの性能と対策を知っていますか', attributes: ['study'] }
        ]
      }
    ]
  }
