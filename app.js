const kpiData = [
  ...
  },
  {
    heading: '1st準備フェーズ',
    items: [
      { id: 'self-role', text: '自分がロールを全うすべきか/イレギュラー対応すべきか判断できましたか', note: ['・0デュエ2イニシ編成で自分イニシ → デュエ的な戦う動きが必要', '・攻めでサイファーが逆サイト管理してくれそう → デフォルト戦術', 'イニシがデュエにくっついてアビリティ投げそう → ラッシュ可能かも'] },
      { id: 'ally-counter', text: '必要に応じて適切に: 敵編成に対するアンチ戦術考案と味方への声掛けはできましたか', note: ['味方が敵の編成から対策を考えられそうか判断する。', '例: ネオンがワイヤーのある所に行かなそうか、行くとしてもアンチワイヤーを考えていそうか、など'] },
      { id: 'weird-teammate', text: '味方に変な奴がいる場合: その人との連携プレイの優先度を下げる決意をしましたか', note: ['例: 「SDGs」「◯◯トロールします」'] }
    ]
  },
  {
